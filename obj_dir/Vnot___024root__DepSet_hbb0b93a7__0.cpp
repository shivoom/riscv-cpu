...
VL_INLINE_OPT VlCoroutine Vnot___024root___eval_initial__TOP__Vtiming__0(Vnot___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vnot__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnot___024root___eval_initial__TOP__Vtiming__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<4>/*127:0*/ __Vtemp_1;
    // Body
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x2f6e6f74U;
    __Vtemp_1[2U] = 0x61766573U;
    __Vtemp_1[3U] = 0x77U;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(4, __Vtemp_1));
    vlSymsp->_traceDumpOpen();
    vlSelfRef.not_tb__DOT__a = 0U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "testbench/not_tb.sv", 
                                         14);
    vlSelfRef.not_tb__DOT__a = 1U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "testbench/not_tb.sv", 
                                         16);
    VL_WRITEF_NX("NOT gate passed\n",0);
    VL_FINISH_MT("testbench/not_tb.sv", 20, "");
}
...
void Vnot___024root___eval_triggers__act(Vnot___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vnot__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnot___024root___eval_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
