...
VL_ATTR_COLD void Vand___024root__trace_init_sub__TOP__0(Vand___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->pushPrefix("and_tb", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vand___024root__trace_full_0_sub_0(Vand___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.and_tb__DOT__a));
    bufp->fullBit(oldp+2,(vlSelfRef.and_tb__DOT__b));
    bufp->fullBit(oldp+3,(((IData)(vlSelfRef.and_tb__DOT__a) 
                           & (IData)(vlSelfRef.and_tb__DOT__b))));
}
